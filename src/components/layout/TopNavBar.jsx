      ...
      <div className="flex justify-between items-center px-8 h-20 max-w-[1200px] mx-auto">
        ...
        <div className="hidden xl:flex items-center relative group">
          ...
          <input 
            ...
            className="bg-surface-container-low border-none rounded-sm pl-10 pr-4 py-2 text-xs w-64 focus:ring-1 focus:ring-primary focus:bg-surface-container-lowest transition-all"
          />
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-4 border-l border-clinical pl-4 ml-2">
            <Link to="/user-profile" className="w-10 h-10 bg-primary rounded-xl flex items-center justify-center text-white shadow-clinical hover:scale-110 active:scale-95 transition-all group" title="Arjun Sharma - View Profile">
